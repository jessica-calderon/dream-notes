    ...
    <footer className="p-4 w-100 bg-dark footer text-center">
      <div className="container">
        ...
        <div className="mt-2">
          ...
          <a href="https://github.com/Christys122" alt="Christy Salazar Github">
            <img
              src={github}
              className="mr-2"
              width="25px"
          ...
          <a
            ...
            alt="Anastasiya Litvinova Github"
          >
            <img
              src={github}
              className="mr-2"
          ...
          <a href="https://github.com/Wumbo-dot" alt="JT Gutierrez Github">
            <img src={github} className="" width="25px" alt="github octocat" />
          </a>
        </div>
      </div>
    </footer>
